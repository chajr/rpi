...
module.exports = class Iluminator
{
    ...
    prepareLog () {
        ...
        logData.sunsetTime = this.sunCalc.sunset.getHours()
            + ':'
        ...
        logData.currentTime = this.isSpecial;
        logData.onTime = this.isSpecial;
        logData.minimalTime = this.isSpecial;
        logData.offTime = this.isSpecial;
        logData.sunsetTime = this.isSpecial;
        logData.downBorder = this.isSpecial;
        logData.shouldTurnLightOn = this.isSpecial;
        logData.force = this.isSpecial;
        logData.launched = this.isSpecial;
        logData.turnOn = this.isSpecial;
        logData.minTime = this.isSpecial;
        logData.maxTime = this.isSpecial;
