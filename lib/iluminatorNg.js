...
module.exports = class Iluminator
{
    ...
    prepareLog () {
        ...
        logData.currentTime = this.currentTime;
        logData.onTime = this.onTime;
        logData.minimalTime = this.minimalTime;
        logData.offTime = this.offTime;
        logData.downBorder = this.downBorder;
