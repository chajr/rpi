...
{
    constructor (date, config, launched, forceOn, sunCalc) {
        this.statusObject = {};
        this.config = config;
        ...
        this.statusObject.force = !forceOn && !turnLightOn;
    ...
    turnLightOff (forceOff) {
        this.statusObject.turnOffStatus = this.statusObject.launched && (this.statusObject.alive || this.statusObject.force || forceOff);
    }
