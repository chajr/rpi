        ...
        this.logger = new (winston.Logger)({
            transports: [
                new (winston.transports.File)({
                    ...
                    filename: this.basePath + 'debug_' + Log.getDate() + '.log',
                    level: 'debug',
                    timestamp: () => {
                        return this.getTime();
                    }
                ...
                new (winston.transports.File)({
                    name: 'warning',
                    json: config.get('app.json_log'),
                    filename: this.basePath + 'warning_' + Log.getDate() + '.log',
                    level: 'warning',
                    timestamp: () => {
                        return this.getTime();
                    }
                ...
                new (winston.transports.File)({
                    name: 'info',
                    json: config.get('app.json_log'),
                    filename: this.basePath + 'info_' + Log.getDate() + '.log',
                    level: 'info',
                    timestamp: () => {
                        return this.getTime();
                    }
                ...
                new (winston.transports.File)({
                    name: 'error',
                    json: config.get('app.json_log'),
                    filename: this.basePath + 'error_' + Log.getDate() + '.log',
                    level: 'error',
                    timestamp: () => {
                        return this.getTime();
                    }
